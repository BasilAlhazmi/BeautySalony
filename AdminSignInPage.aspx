<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignInPage.aspx.cs" Inherits="BeautySalony.AdminSignInPage" %>
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <h4 style="text-align: center">Sign In as Admin 
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox ID="txtUsernameAdmin" CssClass="form-control"  runat="server" placeholder="User Name"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox ID="txtPasswordAdmin" CssClass="form-control"  type="Password" runat="server" placeholder="Password"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
