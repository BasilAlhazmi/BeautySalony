<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAllAdminPage.aspx.cs" Inherits="BeautySalony.ViewAllAdminPage" %>
                ...
                <div class="col-md-10 mx-auto">
                    <div class="card" style="background-color: #effafc">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h2 style="color: #352d7d;">All Admin</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col" style="overflow:auto;height:450px;">
                                    <asp:GridView class="table table-striped table-bordered" ID="GridViewAllAdmin" runat="server" ShowFooter="false"  AutoGenerateColumns="False" OnRowDeleting="GridViewAllAdmin_RowDeleting">
                                        <Columns>
