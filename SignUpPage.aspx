<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpPage.aspx.cs" Inherits="BeautySalony.SignUpPage" %>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox CssClass="form-control" ID="txtLastName" runat="server" placeholder="First Name"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox CssClass="form-control" ID="txtConfirmPassword" type="Password" runat="server" placeholder="Confirm Password"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <asp:Button ID="btnSignUp" class="btn btn-lg btn-block btn-success" runat="server" Text="Save" OnClick="btnSignUp_Click" />
                                                    </div>
                                                    <br />
                                                    <br />
                                                    <br />
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <h6><b>Already have an account? <a href="SignInPage.aspx">Sign In here</a></b></h6>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
