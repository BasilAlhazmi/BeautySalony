...
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Basil','Alhazmi','0559038514','Basil7557','Basilalhazmi10@gmail.com','Basilb10');
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Mosab','Alhazmi','0507717557','MH-75','Mosabalhazmi10@gmail.com','123');
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Saud','Alhazmi','0506345359','SaudAlhazmi','SaudAlhazmi@gmail.com','123');
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Ahmed','Alhazmi','0542396782','AhmedAlhazmi','AhmedAlhazmi@gmail.com','123');
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Asim','Alhazmi','0541963962','AsimAlhazmi','AsimAlhazmi@gmail.com','123');
insert into AdminTable(FirstName,LastName,PhoneNumber,username,EmailAddress,Password)values('Mohammmed','Alhazmi','0536918643','MohammedAlhazmi','MohammedAlhazmi@gmail.com','123');
...
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('2','3','3 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('5','3','1 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('4','8','2 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('3','2','2 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('5','4','1 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('1','5','1 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('4','6','2 Years');
insert into hairstylistSpecialist(HairstylistId,ServiceId,experienceYear)values('2','7','4 Years');
...
select Stylist,Service,time from appointment where Stylist='Linda' and date='02/04/2020' order by(time);


select Stylist,Service,time from appointment where   date='03/04/2020' order by(time);
