<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignInPage.aspx.cs" Inherits="BeautySalony.SignInPage" %>
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <h4 style="text-align: center">Sign In 
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox CssClass="form-control" ID="txtUsernamePassword" type="Password" runat="server" placeholder="Password"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                     <h6><b><a href="ForgetPasswordPage.aspx">Forget Password?</a></b></h6>
                                                     <h6><b><a href="AdminSignInPage.aspx">Sign In As An Admin</a></b></h6>
                                                     <h6><b>Do not have an account? <a href="SignUpPage.aspx">Click Here to sign up!</a></b></h6>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12">
                                                        <asp:Button ID="btnSignIn" class="btn btn-lg btn-block btn-success" OnClick="btnSignIn_Click" runat="server" Text="SignIn" />
                                                    </div>
                                                    <br />
                                                    <br />
                                                    <br />
